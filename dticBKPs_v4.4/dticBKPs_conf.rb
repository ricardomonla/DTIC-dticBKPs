...
TAREAS_CONFIG = [
  ...
  {
    id: :ns8_sinc_nube,
    menu_texto: "☁️  BKPs desde NS8 → rmOneDrive (bkps_ANTIGUOS)",
    tipo_proceso: :rclone_sync,
    origen: "/mnt/ns8Disco3/dtic_BACKUPS/bkps_ANTIGUOS/",
    destino: "rmOneDrive:/dtic_BACKUPS/bkps_ANTIGUOS/",
    eliminar_origen: false,
    sobrescribir_destino: false,
  },
  {
    id: :ns8_sinc_nube,
    menu_texto: "☁️  BKPs desde NS8 → rmOneDrive (bkps_PMOX1)",
    tipo_proceso: :rclone_sync,
    origen: "/mnt/ns8Disco3/dtic_BACKUPS/bkps_PMOX1/",
    destino: "rmOneDrive:/dtic_BACKUPS/bkps_PMOX1/",
    eliminar_origen: false,
    sobrescribir_destino: false,
  },
  {
    id: :ns8_sinc_nube,
    menu_texto: "☁️  BKPs desde NS8 → rmOneDrive (bkps_PMOX2)",
    tipo_proceso: :rclone_sync,
    origen: "/mnt/ns8Disco3/dtic_BACKUPS/bkps_PMOX2/",
    destino: "rmOneDrive:/dtic_BACKUPS/bkps_PMOX2/",
    eliminar_origen: false,
    sobrescribir_destino: false,
  },
  {
    id: :ns8_sinc_nube,
    menu_texto: "☁️  BKPs desde NS8 → rmOneDrive (bkps_PMOX3)",
    tipo_proceso: :rclone_sync,
    origen: "/mnt/ns8Disco3/dtic_BACKUPS/bkps_PMOX3/",
    destino: "rmOneDrive:/dtic_BACKUPS/bkps_PMOX3/",
    eliminar_origen: false,
    sobrescribir_destino: false,
  },
  {
    id: :ns8_sinc_nube,
    menu_texto: "☁️  BKPs desde NS8 → rmOneDrive (bkps_XEN01)",
    tipo_proceso: :rclone_sync,
    origen: "/mnt/ns8Disco3/dtic_BACKUPS/bkps_XEN01/",
    destino: "rmOneDrive:/dtic_BACKUPS/bkps_XEN01/",
    eliminar_origen: false,
    sobrescribir_destino: false,
  },
]